...
# --- HELP: /help (безпечний варіант через HTML)
async def help_cmd(u: Update, c: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "⚙️ <b>Параметри</b>\n"
        "/set_top N — скільки монет у сигналі\n"
        "/set_noise X — фільтр шуму, %\n"
        "/set_trend 2|3|4 — суворість тренду\n"
        "/set_atr N — довжина ATR\n"
        "/set_risk SL TP — стоп/тейк у ATR\n"
        "/set_rr X — мінімальне R:R\n"
        ...
        "🤖 <b>Автопостинг</b>\n"
        "/auto_on N — автоскан кожні N хв\n"
        "/auto_off — вимкнути автоскан\n\n"
        "📋 <b>Списки</b>\n"
        "/wl_add XXXYYY / wl_clear — білий список\n"
        "/bl_add XXXYYY / bl_clear — чорний список\n\n"
        "🎛 <b>Профілі</b>\n"
        "/scalp, /default, /swing\n"
    )
